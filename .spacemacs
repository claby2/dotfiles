...
before packages are loaded."
  ...
  (defun my/waypost-yq ()
    "Run `waypost -yq` and report success or failure in the echo area."
    (interactive)
    ;; call-process args: PROGRAM &optional INFILE BUFFER DISPLAY &rest ARGS
    (let ((exit-code (call-process "waypost"     ; program
                                   nil           ; no stdin
                                   nil           ; no output buffer (silently discarded)
                                   nil           ; no redisplay
                                   "-yqD")))      ; args
      (if (zerop exit-code)
          (message "waypost: sync completed successfully")
        (message "waypost: sync failed (exit code %d)" exit-code))))
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-jump-helm-line ace-link add-node-modules-path afternoon-theme
                          aggressive-indent aio alect-themes all-the-icons
                          ...
                          bubbleberry-theme bui busybee-theme caml
                          centered-cursor-mode cherry-blossom-theme
                          chocolate-theme clean-aindent-mode clues-theme
                          code-cells color-theme-sanityinc-solarized
                          color-theme-sanityinc-tomorrow column-enforce-mode
                          company company-anaconda concurrent ctable
                          cyberpunk-theme cython-mode dakrone-theme dap-mode
                          darkmine-theme darkokai-theme darktooth-theme deferred
                          define-word devdocs diminish dired-quick-sort
                          disable-mouse django-theme docker dockerfile-mode
                          dotenv-mode dracula-theme drag-stuff dumb-jump dune eat
                          ...
                          evil-escape evil-evilified-state evil-mc
                          ...
                          flycheck-elsa flycheck-ocaml flycheck-package
                          flycheck-pos-tip gandalf-theme ggtags golden-ratio
                          ...
                          helm-core helm-cscope helm-descbinds helm-lsp helm-make
                          ...
                          json-snatcher kaolin-themes light-soap-theme link-hint
                          live-py-mode livid-mode load-env-vars lorem-ipsum
                          lsp-docker lsp-mode lsp-origami lsp-pyright lsp-treemacs
                          lsp-ui lush-theme macrostep madhat2r-theme
                          material-theme merlin merlin-company merlin-eldoc
                          merlin-iedit minimal-theme modus-themes moe-theme
                          molokai-theme monochrome-theme monokai-theme multi-line
                          multi-term multi-vterm multiple-cursors mustang-theme
                          nameless naquadah-theme noctilux-theme nodejs-repl nose
                          npm-mode obsidian-theme ocamlformat occidental-theme
                          ocp-indent oldlace-theme omtose-phellack-themes
                          open-junk-file org-superstar organic-green-theme origami
                          overseer package-lint page-break-lines paradox
                          password-generator pcre2el pet phoenix-dark-mono-theme
                          phoenix-dark-pink-theme pip-requirements pipenv pippel
                          planet-theme poetry popwin pos-tip prettier-js
                          professional-theme purple-haze-theme py-isort pydoc
                          pyenv-mode pylookup pytest pythonic pyvenv quickrun
                          railscasts-theme rainbow-delimiters rebecca-theme
                          reformatter restart-emacs reverse-theme ron-mode
                          ruff-format rustic seti-theme shell-pop simple-httpd
                          ...
                          treemacs-persp treemacs-projectile tuareg
                          twilight-anti-bright-theme twilight-bright-theme
                          twilight-theme typescript-mode ujelly-theme
                          underwater-theme undo-fu undo-fu-session utop uuidgen
                          vi-tilde-fringe volatile-highlights vterm vundo
                          web-beautify web-mode wfnames wgrep white-sand-theme
